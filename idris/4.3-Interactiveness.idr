...
search : (store : Store) -> (query : String) -> Vect (Data.Vect.filter (isInfixOf query) (items store)) String
search store query = Data.Vect.filter (isInfixOf query) (items store)
